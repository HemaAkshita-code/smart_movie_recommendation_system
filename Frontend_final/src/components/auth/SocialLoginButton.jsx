...
const SocialLoginButton = ({ provider, onClick }) => {
  ...
  return (
    <Button
      ...
      type="button"
      onClick={onClick}
      className="w-full flex items-center justify-center gap-2 font-sans font-semibold text-xs py-2.5 border-border/45 hover:bg-muted/40 transition-colors"
    >
      {isGoogle ? <GoogleIcon /> : <Github className="w-4 h-4 mr-2" />}
